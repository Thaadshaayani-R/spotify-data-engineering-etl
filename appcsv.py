# app.py - BTS Spotify Dashboard (Clean & Simple)
...
def inject_css():
    ...
    .header-box {
        ...
        border-radius: 10px;
        margin: -0.25rem 0.5rem 0.5rem -0.25rem;  /* reduce top/bottom spacing */
    }
    .header-title {font-family: 'Inter', sans-serif; font-size: 1.5rem; font-weight: 700; color: #fff; margin: 0;}
    ...
    .metric-label {font-size: 0.72rem; color: #fff; margin-top: 2px; text-align: center;}
    .metric-sub {font-size: 0.62rem; color: #fff; margin-top: 3px; text-align: center;}
